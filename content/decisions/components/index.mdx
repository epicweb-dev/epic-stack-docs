...
date: 2023-06-27
status: accepted
description: Using Radix UI and shadcn/ui for components.
categories:
  - ui
  - radix
  - decisions
...
The web platform is severely lacking in terms of UI components. There's pretty minimal
by way of built-in components, and for many that do exist, they are extremely difficult
(if not impossible) to style.
